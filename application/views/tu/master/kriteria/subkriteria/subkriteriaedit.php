...
if(empty($data))
{
	redirect(base_url('tu/master/kriteria/subkriteria').$kriteria);
}
...
echo form_open(base_url('tu/master/kriteria/subkriteriaedit').$kriteria,array('class'=>'form-horizontal'));
?>
