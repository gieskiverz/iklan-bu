...
class Walikelas extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->load->view('tu/walikelas/walikelasview',$d);
    ...
    function add()
    {
		...
		if($this->form_validation->run()==TRUE)
		{
			...
			$this->load->view('tema/header',$meta);
			$this->load->view('tu/walikelas/walikelasadd');
			$this->load->view('tema/footer');
		}
	}
	...
	function edit()
    {
		...
		if($this->form_validation->run()==TRUE)
		{
			...
			$this->load->view('tu/walikelas/walikelasedit',$d);
			$this->load->view('tema/footer');
		}
	}
