...
class Subkriteria extends CI_Controller
{
    ...
    {        
        ...
        $this->load->view('tu/ahp/subkriteria/subkriteriaview',$d);
    ...
    {		
		...
		if($this->form_validation->run()==TRUE)
		{
			...
			if($this->mod_kriteria->subkriteria_add($tipe,$kriteriaid,$opmax,$isi,$opmin,$min,$nilaiid)==TRUE)
			{
				...
				redirect(base_url('tu/ahp/subkriteria').$link);
			}else{
				set_header_message('danger','Tambah Parameter','Gagal menambah parameter');
				redirect(base_url('tu/ahp/subkriteria/add').$link);
			}
		}else{
			$kriteria=$this->input->get('kriteria');
	        ...
	        $d['kriteria']=$kriteria?"?kriteria=".$kriteria:"";
	        $this->load->view('tu/ahp/subkriteria/subkriteriaadd',$d);
	        $this->load->view('tema/footer');
		}
	}
    ...
    {		
		...
		{			
	        ...
	        $this->load->view('tu/ahp/subkriteria/subkriteriaedit',$d);
	        $this->load->view('tema/footer');
		}
	}
