...
class Beasiswa extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->load->view('tu/beasiswa/beasiswa/beasiswaview',$d);
    ...
    function add()
    {
		...
		if($this->form_validation->run()==TRUE)
		{
	        ...
	        $this->load->view('tema/header',$meta);
	        $this->load->view('tu/beasiswa/beasiswa/beasiswaadd');
	        $this->load->view('tema/footer');
		}
	}
	...
	function edit()
    {
		...
		if($this->form_validation->run()==TRUE)
		{
	        ...
	        $this->load->view('tu/beasiswa/beasiswa/beasiswaedit',$d);
	        $this->load->view('tema/footer');
		}
	}
	...
	function proses()
	{
        ...
        $this->load->view('tema/header',$meta);
        $d['data']=$this->mod_bea->beasiswa_data(array('beasiswa_id'=>$id));
        $this->load->view('tu/beasiswa/beasiswa/prosesview',$d);
        $this->load->view('tema/footer');
	}
	...
	function proseshitung()
	{
		...
		if($this->mod_bea->proseshitung($id)==TRUE)
		{
			...
			//redirect(base_url('tu/beasiswa/beasiswa').'?id='.$id);
			echo json_encode(array('status'=>'ok'));
		}else{
			//set_header_message('danger','Proses Beasiswa','Beasiswa gagal diproses');
			//redirect(base_url('tu/beasiswa/beasiswa'));
