...
class Kriteria extends CI_Controller
{
    ...
    {        
        ...
        $this->load->view('tu/beasiswa/matriks/kriteriacontainer',$d);
    ...
    function gethtml()
    {
    	...
    	$d['arr']=$output;
    	$d['beasiswaid']=$id;
    	$this->load->view('tu/beasiswa/matriks/matrikutama',$d);
	}
    ...
    function add()
    {
		...
		if($this->form_validation->run()==TRUE)
		{
        	...
        	$this->load->view('tema/header',$meta);
        	$this->load->view('tu/ahp/kriteria/kriteriaadd');
        	$this->load->view('tema/footer');
		}
	}
    ...
    function updatedata()
    {
		...
		redirect(base_url('tu/ahp/kriteria'));
	}
